...
import AddressForm from "../../address/components/Address.jsx";
      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="md:col-span-1">
            <div className="relative group">
              ...
              <div className="relative bg-[#0C0C12]/80 border border-white/5 rounded-[24px] p-8 flex flex-col items-center backdrop-blur-3xl">
                ...
                <h3 className="mt-6 text-[#F5F0E8] text-xl font-[Georgia,serif] text-center uppercase tracking-tight">
                  {user?.name}
                </h3>
          ...
          <div className="md:col-span-2">
            <div className="bg-[#0C0C12]/80 border border-white/5 rounded-[24px] overflow-hidden backdrop-blur-3xl h-full shadow-2xl">
              <div className="px-8 py-6 border-b border-white/5 bg-white/[0.02] flex justify-between items-center">
                <h4 className="text-[#F5F0E8] text-xs uppercase tracking-[0.2em] font-black">
                  {isEditing ? "Modify Credentials" : "Account Specifications"}
                </h4>
                {!isEditing && (
                  ...
                  <>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-12">
                      <div className="flex flex-col gap-1 border-l border-white/5 pl-4">
                        <span className="text-[rgba(245,240,232,0.4)] text-[9px] uppercase tracking-widest font-bold">
                          Full Name
                        </span>
                      ...
                      <div className="flex flex-col gap-1 border-l border-white/5 pl-4">
                        ...
                        <p className="text-[#F5F0E8]/30 text-[10px] font-mono truncate">
                          {user?._id}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-12 pt-8 border-t border-white/5 flex flex-wrap gap-4">
                      <button
                        ...
                        className="px-10 py-4 rounded-xl bg-[#D4AF37] text-[#08080E] text-[10px] font-black uppercase tracking-[0.2em] hover:shadow-[0_10px_30px_rgba(212,175,55,0.3)] transition-all active:scale-95"
                      >
                        Edit Profile
                      </button>
                      <button className="px-10 py-4 rounded-xl border border-white/10 text-[rgba(245,240,232,0.6)] text-[10px] font-black uppercase tracking-[0.2em] hover:bg-white/5 transition-all">
                        Security
                      </button>
                    </div>
                  </>
