...
const StatCard = ({ label, value, suffix }) => (
  <div className="relative group p-[1px] rounded-[32px] bg-gradient-to-b from-white/10 to-transparent overflow-hidden">
    ...
    <div className="bg-[#0C0C12]/90 backdrop-blur-3xl rounded-[31px] p-8 md:p-10 relative z-10">
      <p className="text-[#D4AF37] text-[10px] uppercase tracking-[0.4em] font-black mb-6 opacity-70">
        {label}
      </p>
      <div className="flex items-baseline gap-1">
        {suffix === "₹" && (
          <span className="text-[#D4AF37] font-[Georgia] text-2xl italic mr-1">
            ₹
          </span>
        )}
    ...
    <div className="min-h-screen bg-[#08080E] pt-[120px] md:pt-[160px] pb-24 px-4 md:px-10 selection:bg-[#D4AF37]/30">
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="mb-8 flex items-center gap-4">
          <p className="text-white/20 text-[9px] uppercase tracking-[0.5em] font-bold shrink-0">
            Navigational Links
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          >
            <div className="bg-[#0C0C12]/90 backdrop-blur-3xl rounded-[31px] p-10 overflow-hidden relative">
              ...
              <span className="absolute -right-4 -bottom-10 text-[120px] font-[Georgia] italic text-white/[0.02] pointer-events-none group-hover:text-[#D4AF37]/5 transition-all duration-700">
                P
              </span>
              ...
              <p className="text-[#F5F0E8] font-[Georgia,serif] italic text-3xl group-hover:translate-x-3 transition-transform duration-500">
                Manage Products{" "}
                <span className="text-[#D4AF37] ml-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  →
                </span>
              </p>
            </div>
