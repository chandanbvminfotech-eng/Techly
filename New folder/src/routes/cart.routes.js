...
import { addToCart, deleteCart, deleteProductFromCart, getCart, updateQuantity } from "../controllers/cart.controller.js";
...
cartRouter.put("/:id",verifyJWT,updateQuantity)
